<div class="flex-1 flex h-full w-full overflow-hidden">
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar p-6">
                <div class="w-full space-y-6">
                    ...
                    <!-- Filter Toolbar -->
                    @include('livewire.pos-reports-ar-settlement.components.filter-card')

                    <!-- Summary KPI Card -->
                    @include('livewire.pos-reports-ar-settlement.components.summary-card')

                    <!-- Settlement Table -->
                    @include('livewire.pos-reports-ar-settlement.components.settlement-table')
    ...
    <!-- Print Template -->
    @include('livewire.pos-reports-ar-settlement.components.print-template')
</div>
