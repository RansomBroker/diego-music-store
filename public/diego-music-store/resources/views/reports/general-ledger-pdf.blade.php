...
<head>
    <meta charset="UTF-8">
    <title>Laporan Buku Besar (General Ledger) - {{ $data['from_date'] }} s.d. {{ $data['to_date'] }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="report-title">LAPORAN BUKU BESAR (GENERAL LEDGER REPORT)</div>
    ...
    @foreach($data['ledgers'] as $ledger)
        <div class="account-header">
            AKUN: {{ $ledger['account_code'] }} - {{ $ledger['account_name'] }} ({{ strtoupper($ledger['classification']) }})
        </div>
