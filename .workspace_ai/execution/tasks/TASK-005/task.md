...
## Acceptance Criteria
- [ ] CRUD `PricingTier` dapat digunakan untuk mengelola nama-nama tingkatan harga.
- [ ] CRUD `Product` dapat digunakan untuk menambah produk dengan tipe Fisik, Bundling, dan Jasa.
- [ ] Di dalam form produk, muncul field input harga secara dinamis untuk seluruh tier harga dan cabang yang terdaftar di database.
- [ ] Form produk mendukung tab pengelolaan varian (warna, ukuran, dll.) dan penentuan harga khusus per varian.
- [ ] Form produk tipe bundling mendukung pemilihan produk-produk komponen penyusunnya beserta kuantitas masing-masing.
