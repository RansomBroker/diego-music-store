                    ...
                    @forelse ($paginatedReportData['paginated_items'] ?? [] as $item)
                        <x-pos.table.tr class="align-top">
                            @if (!empty($item['is_first_item']))
                                ...
                                <x-pos.table.td rowspan="{{ $item['rowspan'] }}" class=" font-bold text-primary dark:text-blue-400 whitespace-nowrap bg-slate-50/40 dark:bg-slate-800/30 border-r border-slate-200 dark:border-slate-800 align-top">
                                    {{ $item['invoice_number'] }}
                                </x-pos.table.td>
                                <x-pos.table.td rowspan="{{ $item['rowspan'] }}" class="font-bold text-slate-900 dark:text-white whitespace-nowrap bg-slate-50/40 dark:bg-slate-800/30 border-r border-slate-200 dark:border-slate-800 align-top">
                                    {{ $item['customer_name'] }}
                            ...
                            @endif
                            <x-pos.table.td class=" font-bold text-slate-800 dark:text-slate-200 whitespace-nowrap">{{ $item['sku'] }}</x-pos.table.td>
                            ...
                            <x-pos.table.td class="text-right  font-bold text-slate-900 dark:text-white whitespace-nowrap">Rp {{ number_format($item['unit_price'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-rose-600 dark:text-rose-400 whitespace-nowrap">Rp {{ number_format($item['discount_amount'], 0, ',', '.') }}</x-pos.table.td>
                            @if (!empty($item['is_first_item']))
                                <x-pos.table.td rowspan="{{ $item['rowspan'] }}" class="text-right  font-bold text-blue-600 dark:text-blue-400 whitespace-nowrap bg-slate-50/40 dark:bg-slate-800/30 border-l border-slate-200 dark:border-slate-800 align-top">
                                    Rp {{ number_format($item['tax_amount'], 0, ',', '.') }}
                                </x-pos.table.td>
                            @endif
                            <x-pos.table.td class="text-right  font-bold text-emerald-600 dark:text-emerald-400 whitespace-nowrap">Rp {{ number_format($item['subtotal'], 0, ',', '.') }}</x-pos.table.td>
                        </x-pos.table.tr>
                    @empty
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                    @forelse ($paginatedReportData['paginated_items'] ?? [] as $row)
                        <x-pos.table.tr>
                            ...
                            <x-pos.table.td class="text-right  font-bold text-slate-900 dark:text-white">Rp {{ number_format($row['subtotal'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-rose-600 dark:text-rose-400">Rp {{ number_format($row['discount_amount'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-blue-600 dark:text-blue-400">Rp {{ number_format($row['tax_amount'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-emerald-600 dark:text-emerald-400">Rp {{ number_format($row['grand_total'], 0, ',', '.') }}</x-pos.table.td>
                        </x-pos.table.tr>
                    @empty
            ...
            @elseif ($viewMode === 'per_nota')
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                    @forelse ($paginatedReportData['paginated_items'] ?? [] as $nota)
                        <x-pos.table.tr>
                            <x-pos.table.td class=" font-bold text-primary dark:text-blue-400">{{ $nota['invoice_number'] }}</x-pos.table.td>
                            <x-pos.table.td class=" font-bold text-slate-800 dark:text-slate-200">{{ $nota['date'] }}</x-pos.table.td>
                            ...
                            <x-pos.table.td class="text-right  font-bold text-slate-900 dark:text-white">Rp {{ number_format($nota['subtotal'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-rose-600 dark:text-rose-400">Rp {{ number_format($nota['discount_amount'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-blue-600 dark:text-blue-400">Rp {{ number_format($nota['tax_amount'], 0, ',', '.') }}</x-pos.table.td>
                            <x-pos.table.td class="text-right  font-bold text-emerald-600 dark:text-emerald-400">Rp {{ number_format($nota['grand_total'], 0, ',', '.') }}</x-pos.table.td>
                        </x-pos.table.tr>
                    @empty
                ...
                <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                    @forelse ($paginatedReportData['paginated_items'] ?? [] as $rank => $prod)
                        <x-pos.table.tr>
                            ...
                            <x-pos.table.td class=" font-bold text-slate-800 dark:text-slate-200">{{ $prod['sku'] }}</x-pos.table.td>
                            ...
                            <x-pos.table.td class="text-right  font-bold text-emerald-600 dark:text-emerald-400">Rp {{ number_format($prod['total_revenue'], 0, ',', '.') }}</x-pos.table.td>
                        </x-pos.table.tr>
                    @empty
