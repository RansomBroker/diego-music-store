<div class="flex-1 flex h-full w-full overflow-hidden">
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar p-6">
                <div class="w-full space-y-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <h1 class="text-2xl font-black text-slate-900 dark:text-white leading-tight">
                                Laporan Kas Harian {{ $currentBranch?->name ?? '' }}
                            </h1>
                        </div>
                    ...
                    @include('livewire.pos-reports-daily-cash.components.filter-card')

                    <!-- KPI Cards -->
                    @include('livewire.pos-reports-daily-cash.components.summary-cards')

                    <!-- Table Card -->
                    @include('livewire.pos-reports-daily-cash.components.cash-table')
    ...
    @include('livewire.pos-reports-daily-cash.components.print-template')
</div>
