<div class="flex-1 flex h-full w-full overflow-hidden">
        ...
        <main class="flex-1 flex flex-col h-full overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar p-6">
                <div class="w-full space-y-6">
                    ...
                    <!-- Filter Toolbar -->
                    @include('livewire.pos-branches.components.filter-toolbar')

                    <!-- Table Card -->
                    @include('livewire.pos-branches.components.branches-table')
    ...
    @include('livewire.pos-branches.components.branch-modal')
</div>
