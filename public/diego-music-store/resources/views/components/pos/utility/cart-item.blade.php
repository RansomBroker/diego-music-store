...
<div class="flex flex-col gap-2.5 pb-4 border-b border-slate-100 dark:border-slate-700/50 last:border-b-0 last:pb-0">
    ...
    <div class="space-y-2.5 pl-[68px]">
        ...
        <div class="flex gap-3">
            ...
            <div class="flex-1">
                ...
                <div class="relative flex items-center bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200/50 dark:border-slate-700/60 overflow-hidden h-8">
                    <i class="ph ph-tag-chevron text-slate-400 dark:text-slate-550 text-xs absolute left-2 pointer-events-none"></i>
                    <select 
                    ...
                    <i class="ph ph-caret-down text-slate-400 dark:text-slate-550 absolute right-2 pointer-events-none text-[10px]"></i>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="relative flex items-center bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200/50 dark:border-slate-700/60 overflow-hidden h-8">
                <i class="ph ph-note-pencil text-slate-400 dark:text-slate-555 text-xs absolute left-2 pointer-events-none"></i>
                <input 
                    type="text" 
