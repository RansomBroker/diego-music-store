...
<head>
    <meta charset="UTF-8">
    <title>Laporan Buku Vendor (Kartu Hutang Supplier) - {{ $data['from_date'] }} s.d. {{ $data['to_date'] }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        ...
        <div class="report-title">LAPORAN BUKU VENDOR (KARTU HUTANG SUPPLIER)</div>
    ...
    @foreach($data['vendors'] as $vendor)
        <div class="account-header">
            SUPPLIER: {{ $vendor['supplier_code'] }} - {{ $vendor['supplier_name'] }} (Telp: {{ $vendor['supplier_phone'] }})
        </div>
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;">No. Bukti / Ref</th>
                    <th style="width: 25%;">Keterangan</th>
                    <th style="width: 12%;" class="text-right">Pembelian (Rp)</th>
                    <th style="width: 13%;" class="text-right">Pelunasan (Rp)</th>
                    <th style="width: 12%;" class="text-right">Saldo Hutang (Rp)</th>
                </tr>
            </thead>
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-right" style="color: #6b7280; font-style: italic;">Tidak ada mutasi hutang pada periode ini</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
