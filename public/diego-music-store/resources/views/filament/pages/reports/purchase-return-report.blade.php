<x-filament-panels::page>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm">
            ...
            <div class="text-xl font-extrabold  text-amber-600 dark:text-amber-400 mt-1">
                    ...
                    <table class="w-full text-xs text-left">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @foreach ($selectedReturnDetail['items'] as $it)
                                <tr>
                                    <td class="p-2.5  text-gray-500">{{ $it['sku'] }}</td>
                        ...
                        <tfoot class="bg-gray-50 dark:bg-gray-800 font-bold border-t border-gray-200 dark:border-gray-700">
                            <tr>
                                ...
                                <td class="p-2.5 text-right  font-black text-emerald-600 text-sm">Rp {{ number_format($selectedReturnDetail['total_amount'], 0, ',', '.') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
