<div class="flex h-screen w-full overflow-hidden bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar p-6">
            <div class="w-full space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden transition-colors">
                    <!-- Top Action Bar -->
                    @include('livewire.pos-vouchers.components.toolbar')

                    <!-- Table & Pagination -->
                    @include('livewire.pos-vouchers.components.vouchers-table')
                </div>
    ...
    @include('livewire.pos-vouchers.components.voucher-modal')

    <!-- Modal Konfirmasi Hapus -->
    @include('livewire.pos-vouchers.components.delete-modal')
</div>
