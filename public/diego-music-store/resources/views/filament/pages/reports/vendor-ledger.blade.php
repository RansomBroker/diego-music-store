            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h4 class="font-bold text-sm tracking-wide">
                        {{ $data['selected_supplier'] ? ('BUKU VENDOR / KARTU HUTANG: ' . $data['selected_supplier']->name) : 'REKAPITULASI KARTU HUTANG SELURUH SUPPLIER' }}
                    </h4>
    ...
    <div class="space-y-6">
                    ...
                    <table class="w-full text-left text-sm">
                        <thead>
                            <tr class="bg-gray-100/70 dark:bg-white/5 text-gray-700 dark:text-gray-300 text-xs uppercase font-bold border-b border-gray-300 dark:border-gray-700">
                                ...
                                <th class="py-2.5 px-6 w-40">Jenis Transaksi</th>
                                <th class="py-2.5 px-6 w-44">No. Bukti / Ref</th>
                                <th class="py-2.5 px-6">Keterangan</th>
                                <th class="py-2.5 px-6 text-right w-36">Pembelian Baru</th>
                                <th class="py-2.5 px-6 text-right w-36">Pelunasan Hutang</th>
                                <th class="py-2.5 px-6 text-right w-40">Saldo Hutang</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="py-3 px-6 text-center text-gray-400 text-xs italic">
                                        Tidak ada mutasi hutang supplier pada periode ini.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        @empty
            <div class="p-12 text-center bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm">
                ...
                <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">Tidak Ada Data Supplier / Vendor Ditemukan</p>
                <p class="text-xs text-gray-400 mt-1">Silakan sesuaikan filter supplier atau tanggal pada form di atas.</p>
            </div>
        @endforelse
    </div>
</x-filament-panels::page>
