<div class="flex-1 flex h-full w-full overflow-hidden">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div>
                            ...
                            <h1 class="text-2xl font-black text-slate-900 dark:text-white leading-tight">
                                Manajemen Barang Service & Reparasi {{ $currentBranch?->name ? '— ' . $currentBranch->name : '' }}
                            </h1>
                        </div>
                    </div>
                    <!-- KPI Summary Cards -->
                    @include('livewire.pos-service-management.components.summary-cards')

                    <!-- Table Card & Pagination -->
                    @include('livewire.pos-service-management.components.orders-table')
    ...
    @include('livewire.pos-service-management.components.update-modal')
</div>
